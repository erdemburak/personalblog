    ...
    return (<>
        <div style={{ minHeight: '90vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: '50px' }}>
            ...
            <div className='contact-address'>
                ...
                <div>
                    <a href='https://www.linkedin.com/in/burak-erdem-a8839a237/' target='_blank' rel='noreferrer'><i className="fa-brands fa-linkedin fa-xl" style={{ fontSize: '30px' }} /><span> https://www.linkedin.com/in/burak-erdem-a8839a237/</span></a><br />
                </div>
                <div>
