...
function Contact() {
    return (<>
        <div className='contact-page'>
            <div>
                <h4 className='contact-h4'>You can reach me with the links below</h4>
            </div>
            <div className='contact-address'>
                ...
                <div>
                    <a href='https://www.linkedin.com/in/burak-erdem-a8839a237/' target='_blank' rel='noreferrer'><i className="fa-brands fa-linkedin fa-xl linkedin-size" /><span> https://www.linkedin.com/in/burak-erdem-a8839a237/</span></a><br />
                </div>
                <div>
